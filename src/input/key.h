...
namespace gbs_opus
{
    enum class key : int {
        ...
        LeftCommand = SDL_SCANCODE_LCTRL,
        RightCommand = SDL_SCANCODE_RCTRL,
#endif
        ...
        BrowserBookmarks = SDL_SCANCODE_AC_BOOKMARKS,
        BrowserForward = SDL_SCANCODE_AC_FORWARD,
        ...
        KeyboardIllumToggle = SDL_SCANCODE_KBDILLUMTOGGLE,
        KeyboardIllumDown = SDL_SCANCODE_KBDILLUMDOWN,
